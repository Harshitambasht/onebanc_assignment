            ...
            if (!opts.validate || opts.validate(src, svg, use)) {
              ...
              if (url.length) {
                ...
                xhr ||
                  ...
                  xhr.send(),
                  (xhr._embeds = [])),
                  xhr._embeds.push({ parent: parent, svg: svg, id: id }),
...
(function (global, factory) {
    ...
    on: {
      ...
      click: function click(e) {
        ...
        if (
          ...
          else swiper.emit("paginationHide", swiper);
        ...
        a11y: {
          liveRegion: $(
            '\x3cspan class\x3d"' +
              ...
              '" aria-live\x3d"assertive" aria-atomic\x3d"true"\x3e\x3c/span\x3e'
          ),
        },
      });
  ...
  var History = {
    ...
    setHistory: function setHistory(key, index) {
      ...
      else win.history.pushState({ value: value }, null, value);
    },
    ...
    onHashCange: function onHashCange() {
      ...
      if (newHash !== activeSlideHash) {
        var newIndex = swiper.$wrapperEl
          .children(
            "." + swiper.params.slideClass + '[data-hash\x3d"' + newHash + '"]'
          )
          .index();
      ...
      for (var i = 0; i < slides.length; i += 1) {
        ...
        if (params.slideShadows) {
          ...
          if (shadowBefore.length === 0) {
            shadowBefore = $(
              '\x3cdiv class\x3d"swiper-slide-shadow-' +
    ...
    onThumbClick: function onThumbClick() {
      ...
      if (swiper.params.loop) {
        ...
        var prevIndex = swiper.slides
          .eq(currentIndex)
          .prevAll('[data-swiper-slide-index\x3d"' + slideToIndex + '"]')
          .eq(0)
          .index();
        var nextIndex = swiper.slides
          .eq(currentIndex)
          .nextAll('[data-swiper-slide-index\x3d"' + slideToIndex + '"]')
          .eq(0)
          .index();
      ...
      if (swiper.realIndex !== thumbsSwiper.realIndex) {
        ...
        if (thumbsSwiper.params.loop) {
          ...
          var prevThumbsIndex = thumbsSwiper.slides
            .eq(currentThumbsIndex)
            .prevAll('[data-swiper-slide-index\x3d"' + swiper.realIndex + '"]')
            .eq(0)
            .index();
          var nextThumbsIndex = thumbsSwiper.slides
            .eq(currentThumbsIndex)
            .nextAll('[data-swiper-slide-index\x3d"' + swiper.realIndex + '"]')
            .eq(0)
            .index();
      ...
      if (
        ...
        for (var i = 0; i < thumbsToActivate; i += 1)
          thumbsSwiper.$wrapperEl
            .children(
              '[data-swiper-slide-index\x3d"' + (swiper.realIndex + i) + '"]'
            )
